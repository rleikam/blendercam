...
class OperationProperties(bpy.types.PropertyGroup):
    ...
    optimisation: PointerProperty(
        type=OptimizationProperties
    )

    expansion: PointerProperty(
        type=OperationListExpansionsProperties
    )

    name: StringProperty(
        name="Operation Name",
        default="Operation",
        update=updateOperationName
    )
    ...
    minz_from_material: BoolProperty(
    ...
    spindle_rotation_direction: EnumProperty(
    ...
    free_movement_height: FloatProperty(
