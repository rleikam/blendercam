...
class CAMOptimizationProperties(PropertyGroup):
    ...
    optimize_threshold: FloatProperty(
        ...
        max=1000, precision=20, update=update_operation)
    ...
    pixsize: FloatProperty(
        ...
        precision=PRECISION, unit="LENGTH", update=update_zbuffer_image)
    ...
    exact_subdivide_edges: BoolProperty(
        ...
        default=False, update=update_exact_mode)
    ...
    simulation_detail: FloatProperty(
        ...
        max=0.01, precision=PRECISION, unit="LENGTH", update=update_operation)